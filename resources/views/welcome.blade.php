              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">VI, Laggos
                      <br> 
                    </p>
                    <h1 class="intro-title mb-4 ">
                      <span class="color-b">3 </span> Bedroom
                      <br> Luxury Home
                    </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">rent | &#8358; 700,000</span></a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                      <span class="color-b">5 </span> Bedrooms
                      <br> Luxury Home
                    </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">rent | &#8358; 7,800,000</span></a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="table-cell">
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">Ajah, Lagos
                      <br> 
                    </p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">2 </span> Rooms
                      <br> A Standard Flat
                    </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">rent | &#8358; 120,000</span></a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="property-single.html">5 bedroom flat
                          <br /> Ajao Estate, Isolo Lagos</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      <div class="price-box d-flex">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="property-single.html">3 standard duplex
                          <br />Lekki, Phase 2, Magodo Lagos</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      <div class="price-box d-flex">
